...
BUILDIN_FUNC(fstatus)	// Gladius
{
	...
	clif_status_change(sd, icon, state, time, 0, 0, 0);
...
// [RomuloSM]: Adiciona um Random Option em um Ovo de Pet.
...
struct script_function buildin_func[] = {
	...
	//
	BUILDIN_DEF(fstatus,"iiii"),	// Gladius
	BUILDIN_DEF(goto,"l"),
